...
WebUI.click(findTestObject('Page_H s ca ti  The Movie Database (TMDB)/div_Movies'))

WebUI.click(findTestObject('Page_H s ca ti  The Movie Database (TMDB)/img_The Movie Database (TMDB)'))

WebUI.click(findTestObject('Page_The Movie Database (TMDB)/img_Phim Super Mario Thin H'))

WebUI.click(findTestObject('Page_Phim Super Mario Thin H (2026)  The Mo_90cbf4/div_vibes_label'))

WebUI.click(findTestObject('Page_Phim Super Mario Thin H (2026)  The Mo_90cbf4/div_k-slider-track'))

WebUI.click(findTestObject('Page_Phim Super Mario Thin H (2026)  The Mo_90cbf4/div_vibes_submit'))
