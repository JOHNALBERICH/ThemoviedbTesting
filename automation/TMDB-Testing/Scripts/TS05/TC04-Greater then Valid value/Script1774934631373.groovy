...
WebUI.click(findTestObject('Page_The Movie Database (TMDB)/img_Hoppers_ C Nhy K Diu'))

WebUI.click(findTestObject('Page_Hoppers C Nhy K Diu (2026)  The Movie _813314/div_vibes_label'))

WebUI.click(findTestObject('Page_Hoppers C Nhy K Diu (2026)  The Movie _813314/span_drag'))

WebUI.click(findTestObject('Page_Hoppers C Nhy K Diu (2026)  The Movie _813314/div_vibes_submit'))
