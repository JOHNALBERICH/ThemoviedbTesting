...
WebUI.click(findTestObject('Page_The Movie Database (TMDB)/div_glyphicons_v2 circle-more white'))

WebUI.click(findTestObject('Page_The Movie Database (TMDB)/div_hover 1159559 on'))

WebUI.click(findTestObject('Page_The Movie Database (TMDB)/img_Scream 7'))

WebUI.click(findTestObject('Page_Scream 7 (2026)  The Movie Database (TMDB)/a_watchlist'))
