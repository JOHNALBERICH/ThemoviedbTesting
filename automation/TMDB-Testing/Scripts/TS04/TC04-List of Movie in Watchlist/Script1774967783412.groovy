...
WebUI.click(findTestObject('Page_My Profile  The Movie Database (TMDB)/span_A'))

WebUI.click(findTestObject('Page_My Profile  The Movie Database (TMDB)/a_Watchlist'))
